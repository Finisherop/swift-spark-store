...
export default function Privacy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - SwiftMart</title>
        <meta name="description" content="SwiftMart Privacy Policy - We value your privacy and do not collect personal information. Learn about our data practices and affiliate partnerships." />
        <meta name="keywords" content="privacy policy, data protection, affiliate links, privacy, data collection" />
