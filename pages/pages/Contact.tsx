  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with SwiftMart through social media, email, or direct messaging. We're here to help with any questions or feedback." />
        <meta name="keywords" content="contact, support, customer service, social media, email" />
